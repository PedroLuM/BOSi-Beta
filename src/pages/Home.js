    ...
    return (
        <div>
            ...
            <Hero>
                ...
                <h1 ref={el => titleAnim = el} className="big-title">This is the house of <span>BOSi</span> <br /> Our studios offer the best value, with reliable production services,
for the Game, Film, XR, and Toy industries..</h1>
            </ Hero>
            <Works />
            <Footer />
        </div>
